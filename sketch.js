...
function setup() {
  ...
  leftWall = new Base(275, height / 2 + 50, 550, 100, "#8d6e63", true);
  rightWall = new Base(width - 280, height / 2 + 50, 550, 100, "#8d6e63", true);
  ...
  jointPoint = new Base(width - 550, height / 2 + 10, 40, 20, "#8d6e63", true);
